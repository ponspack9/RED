...
bool j1Gui::Start()
{
	...
	start_button	 ->movable = false;	start_button	->Center(0, -140);
	continue_button	 ->movable = false;	continue_button	->Center(0,-70);
	settings_button	 ->movable = false;	settings_button	->Center();
	exit_button    	 ->movable = false;	exit_button		->Center(0, 70);
	credits_button	 ->movable = false;  
